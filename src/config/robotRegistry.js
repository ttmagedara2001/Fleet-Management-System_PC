...
export const ROBOT_REGISTRY = {
    ...
    'device0011233': [
        { id: 'R-101', name: 'Orion', type: 'Transport', zone: 'Sector 1' },
        { id: 'R-102', name: 'Nova', type: 'Inspection', zone: 'Sector 2' },
        { id: 'R-103', name: 'Pulsar', type: 'Assembly', zone: 'Sector 3' },
        { id: 'R-104', name: 'Quasar', type: 'Quality Control', zone: 'Sector 4' },
        { id: 'R-105', name: 'Nebula', type: 'Maintenance', zone: 'Sector 5' }
    ],
    
    // Device: device9988
    'device9988': [
        { id: 'R-201', name: 'Atlas', type: 'Transport', zone: 'Bay 1' },
        { id: 'R-202', name: 'Titan', type: 'Inspection', zone: 'Bay 2' },
        { id: 'R-203', name: 'Helios', type: 'Assembly', zone: 'Bay 3' },
        { id: 'R-204', name: 'Apollo', type: 'Quality Control', zone: 'Bay 4' },
        { id: 'R-205', name: 'Zeus', type: 'Maintenance', zone: 'Bay 5' }
    ]
};

// Default robot template (for devices not in registry)
export const DEFAULT_ROBOTS = [
    { id: 'R-X01', name: 'Unit-1', type: 'General', zone: 'Default' },
    { id: 'R-X02', name: 'Unit-2', type: 'General', zone: 'Default' },
    { id: 'R-X03', name: 'Unit-3', type: 'General', zone: 'Default' },
    { id: 'R-X04', name: 'Unit-4', type: 'General', zone: 'Default' },
    { id: 'R-X05', name: 'Unit-5', type: 'General', zone: 'Default' }
];
